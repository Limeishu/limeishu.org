        ...
        data: [
          ...
          },
          {
            ...
            'ko': [
              ...
              '투청(土城),딩푸(頂埔)에서 705번,706번 버스를 타고 지아오시리(礁溪里)에서 하차 도보10분, 혹은 916번버스를 타고 ,싼샤옛거리(三峽老街)정류장에서 하차 도보 약10분',
              '타이베이시똥취(台北市東區)에서 939번버스를  타고, 타이베이대학교싼샤캠퍼스(台北大學三峽校區)에서 하차 도보 약20분',
              '수린(樹林),신좡(新莊)에서  885번,802번버스를 타고, 싼샤옛거리(三峽老街)정류장에서 내려 도보 10분',
